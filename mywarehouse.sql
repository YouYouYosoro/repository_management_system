...
-- Records of customer
-- ----------------------------
INSERT INTO `customer` VALUES (1, '白给超市', '广东省广州市天河区xxxx', '李老八', '13578945612');
INSERT INTO `customer` VALUES (2, '京东商城', '广东省广州市天河区xxxx', '鸽子', '13507521234');
INSERT INTO `customer` VALUES (3, '天猫超市', '广东省东莞市xxxx', '张三', '13566664520');
...
CREATE TABLE `goods`  (
  `goods_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '货物id',
  `name` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '货物名',
  `provider_id` int(11) NULL DEFAULT NULL COMMENT '供货商id',
...
CREATE TABLE `input_form`  (
  ...
  `change_number` int(11) NULL DEFAULT NULL,
  `user_id` int(11) NULL DEFAULT NULL COMMENT '负责人',
...
INSERT INTO `leftmenu` VALUES (8, 3, '入库', '&#xe65b;', '/sys/toInputManager', 0);
INSERT INTO `leftmenu` VALUES (9, 3, '出库', '&#xe65a;', '/sys/toOutputManager', 0);
INSERT INTO `leftmenu` VALUES (17, 4, '角色管理', '&#xe650;', '/sys/toRoleManager', 0);
INSERT INTO `leftmenu` VALUES (18, 4, '用户管理', '&#xe612;', '/sys/toUserManager', 0);
INSERT INTO `leftmenu` VALUES (126, 2, '商品管理', '&#xe658;', '/sys/toGoodsManager', 0);
INSERT INTO `leftmenu` VALUES (127, 3, '仓库基础设置', '&#xe716;', '/sys/toWarehouseManager', 0);
...
CREATE TABLE `provider`  (
  `provider_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '供货商id',
...
-- Records of provider
-- ----------------------------
INSERT INTO `provider` VALUES (1, '惠州饮料供应商', '广东省惠州市惠城区xxx', '张三', '13533331234');
INSERT INTO `provider` VALUES (2, '广州饮料供应商', '广东省广州市天河区xxxx', '李四', '13522221234');
INSERT INTO `provider` VALUES (3, '东莞饮料供应商', '广东省东莞市xxx', '王五', '13511111234');
INSERT INTO `provider` VALUES (4, '新来的饮料供应商', '河北省圣地亚哥', '我到河北省来', '13512345678');
...
INSERT INTO `role` VALUES (1, '1号仓库管理员', '能够操作1号仓库', 1, '2020-06-29 00:00:00');
INSERT INTO `role` VALUES (2, '2号仓库管理员', '能够操作2号仓库', 1, '2020-06-29 00:00:00');
INSERT INTO `role` VALUES (3, '3号仓库管理员', '能够操作3号仓库', 1, '2020-06-29 00:00:00');
INSERT INTO `role` VALUES (4, '4号仓库管理员', '4号仓库管理员', 0, '2020-07-02 14:50:14');
INSERT INTO `role` VALUES (5, '5号仓库管理员', '能够操作5号仓库', 0, '2020-06-29 00:00:00');
...
CREATE TABLE `stock`  (
  ...
  `upper_alert` int(11) NULL DEFAULT NULL,
  `under_alert` int(11) NULL DEFAULT NULL
...
-- Records of tb_user
-- ----------------------------
INSERT INTO `tb_user` VALUES (1, 0, '576078726', '532ac00e86893901af5f0be6b704dbc7', '黄杰胜', 22, '男', '04A93C74C8294AA09A8B974FD1F4ECBB');
...
INSERT INTO `tb_user` VALUES (5, 3, 'cym', '532ac00e86893901af5f0be6b704dbc7', 'cym', 22, '男', '04A93C74C8294AA09A8B974FD1F4ECBB');
INSERT INTO `tb_user` VALUES (6, 3, '郑创坚', '4614066f15c698fea1ce147bd5e19694', '郑创坚', 22, '男', '04A93C74C8294AA09A8B974FD1F4ECBB');
INSERT INTO `tb_user` VALUES (7, 2, '老干妈', '532ac00e86893901af5f0be6b704dbc7', '老干妈', 60, '女', '04A93C74C8294AA09A8B974FD1F4ECBB');
INSERT INTO `tb_user` VALUES (9, NULL, '添加测试', '754318f3c7bd27fec79205412da92186', 'hhh', 23, '女', 'E6E2CC1D172D42D7B5949FEDF1C8C00F');
...
-- ----------------------------
INSERT INTO `warehouse` VALUES (1, '惠州仓库', '广东省惠州市惠东县平山镇123仓库');
INSERT INTO `warehouse` VALUES (2, '广州仓库', '广东省广州市番禺区大学城仓库');
INSERT INTO `warehouse` VALUES (3, '东莞仓库', '广东省东莞市xxx仓库');
INSERT INTO `warehouse` VALUES (4, '圣地亚哥2', '河北省圣地亚哥2号分部');
INSERT INTO `warehouse` VALUES (5, '圣地亚哥3', '河北省圣地亚哥3号分部');
